...
import { GiOverInfinity, GiMicrochip, GiWhiteBook, GiMaterialsScience } from "react-icons/gi";
...
const CategoryBooks = () => {
  ...
  const renderIcon = (cat) => {
    switch (cat) {
      case "All": return <GiOverInfinity className="text-xl" />;
      case "Tech": return <GiMicrochip className="text-xl" />;
      case "Story": return <GiWhiteBook className="text-xl" />;
      case "Science": return <GiMaterialsScience className="text-xl" />;
      default: return <GiOverInfinity />;
    }
  };
