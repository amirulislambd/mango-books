...
const Navbar = async () => {
  ...
  return (
    <div className=" md:bg-white/10 md:backdrop-blur-md shadow-xl z-50 sticky top-0 mx-2">
      <div className="w-full py-2 md:py-4 border-b-2 border-white/30  md:border-none rounded-full md:rounded-2xl  container mx-auto px-4 flex items-center justify-between">
